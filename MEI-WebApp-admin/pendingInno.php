            ...
            <div class="tables">
                <div class="last-appointments">
                    <div class="heading">
                        ...
                        <ul class="nav2">
                        <li><a href="innovations.php" style="background-color: #077E8C; width: 100px; text-align: center; border-bottom: 4px solid black;">All</a></li>
                    </ul>
                    </div>
                    <table class="product">
                        <thead>
                        ...
                        <tbody>
                            <?php
                                 class Renderer {
                                    ...
                                    echo "<td data-label='Accept/Reject'>"; ?> 
                                        <a href="confirmStatusChange.php?id=<?php echo $docId; ?>&name=innoAccept"><i class="fas fa-check-circle" style="font-size:24px;color:#51FF5E"></i></a>
                                        <a href="confirmStatusChange.php?id=<?php echo $docId; ?>&name=innoReject"><i class='fas fa-ban' style='font-size:24px;color:#FF5151'></i></a>
                                    <?php echo "</td>";
                                    echo "</tr>";
                                    }
                                }
                                ...
                                $querySnapshot = $firestoreManager->getInnovations($ref_table,$odering_column,$start_from,$per_page_record);
                                $i = 1;
                        ...
                        <div class="pagination">    
                            ...
                            if($page>=2){   
                                echo "<a href='pendingInno.php?page=".($page-1)."'>  Prev </a>";   
                            }       
                   
                            for ($i=1; $i<=$total_pages; $i++) {   
                                if ($i == $page) {   
                                    $pagLink .= "<a class = 'active' href='pendingInno.php?page=".$i."'>".$i." </a>";   
                                 }               
                                else  {   
                                    $pagLink .= "<a href='pendingInno.php?page=".$i."'>".$i." </a>";     
                                }   
                            };     
                            echo $pagLink;   
  
                            if($page<$total_pages){   
                                echo "<a href='pendingInno.php?page=".($page+1)."'>  Next </a>";   
                            }   
