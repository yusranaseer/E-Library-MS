                ...
                <div class="divide-3">
                    <div class="add">
                        <div class="heading">
                            ...
                            <button class="open-button" onclick="openForm()">+Add News Papers</button>
                        </div>
...
<div class="form-popup" id="myForm">
  <form method="POST" class="form-container" enctype="multipart/form-data">
    ...
    <label for="Category"><b>Date</b></label>
    <input type="date" name="date">

    <label for="Category"><b>Paper</b></label>
    <input type="text" name="link" placeholder="Paper Link">

    <input type="submit" name="add_news" value="ADD" class="btn" style="border-color: transparent; width: 45%; font-weight: bold; cursor:pointer;">
...
<?php
                        if(isset($_POST["add_news"]))
                        {
                            ...
                            if($name == null || $date == null || $link == null)
                            {
                                ?>
                                    <script type="text/javascript">
                                        swal({
                            ...
                            else
                            {
                                ...
                                $newsRef_result = $firestore->collection($news_table)->add($newsData);
                                if($newsRef_result)
                                {
                                    ?>
                                    <script type="text/javascript">
                    ...
                    <table class="product" id="myTable">
                        ...
                        <tbody>
                            <?php
                                class Renderer {
                                    ...
                                    echo "<td data-label='Date'>"; echo $row['date']; echo "</td>";
                                    echo "<td data-label='Actions'>"; ?> 
                                        <a href="<?php echo $row["paper"]; ?>"> <i class="far fa-eye"></i> </a>
                                        <a href="deleteConfirm.php?id=<?php echo $docId; ?>&name=news"> <i class="far fa-trash-alt"></i> </a>
                                    <?php echo "</td>";
                        ...
                        <div class="pagination">    
                            ...
                            if($page>=2){   
                                echo "<a href='news.php?page=".($page-1)."'>  Prev </a>";   
                            }       
                   
                            for ($i=1; $i<=$total_pages; $i++) {   
                                if ($i == $page) {   
                                    $pagLink .= "<a class = 'active' href='news.php?page=".$i."'>".$i." </a>";   
                                 }               
                                else  {   
                            ...
                            if($page<$total_pages){   
                                echo "<a href='news.php?page=".($page+1)."'>  Next </a>";   
                            }   
