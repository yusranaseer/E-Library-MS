...
else
{
 ...
 <html>  
      <head>  
           <title>ADMIN | Monthly Purchase Order Report <?php echo $Month; echo " "; echo $year; ?></title>  
      ...
      <body>  
           ...
           <div class="container" style="width:50%;">  
                <h3 align="center">Monthly Purchase Order Report <?php echo $Month; echo " "; echo $year; ?></h3>                 
                <br />  
                <form method="post" action="exportmonthlypoCSV.php" align="center">  
