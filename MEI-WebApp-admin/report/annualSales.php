...
$year = date("Y");
 $result = mysqli_query($link, "select * from tbl_order where order_date like '$year%' ");  
 ?>  
 <!DOCTYPE html>  
 <html>  
      <head>  
           <title>ADMIN | Annual Sales Report <?php echo $year; ?></title>  
      ...
      <body>  
           ...
           <div class="container" style="width:50%;">  
                <h3 align="center">Annual Sales Report <?php echo $year; ?></h3>                 
                <br />  
                <form method="post" action="exportannualsalesCSV.php" align="center">  
