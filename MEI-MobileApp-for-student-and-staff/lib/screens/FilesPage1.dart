...
class filesPage1 extends StatefulWidget {
  ...
  const filesPage1(
      ...
      required this.widgetnavigate});

  @override
  State<StatefulWidget> createState() {
    return _filesPage1State();
  }
}

class _filesPage1State extends State<filesPage1> {
  ...
  Widget build(BuildContext context) {
    void _navigateToPreviousPage() {
      Navigator.pop(context,
          MaterialPageRoute(builder: (context) => widget.widgetnavigate));
    }
